...
if menu_file and rules_file:
    ...
    "המבורגר בקר": ['המבורגר'],
    "קציצות בקר ברוטב": ['קציצות בשר ברוטב אדום על קוסקוס', 'קציצות ברוטב אדום פיקנטיי', 'קציצות בקר'],
    "ממולאים קטנים": ['פרגית ממולאת על מצע אורז וירקות בתנור', 'פילה פילו ממולא בתערובת בשר עגל', 'חציל ממולא', 'עלי גפן ממולאים', 'כרוב  פלפל וארטישוק ממולא ברוטב', 'מוסקה עגבנייה ופלפל ממולא', 'פלפלים חציל  ממולאים ברוטב הבית'],
    "כרע עוף ממולא באורז": ['פרגית ממולאת אורז לצד ירקות צלויים', 'פרגית ממולאת על מצע אורז וירקות בתנור'],
    "בקלוואת בשר": ['בקלאוות בשר מדפי פילו בסגנון סוכריה'],
    "קציצות דג": ['קציצות דג', 'קציצות דג ברוטב לימוני', 'קציצות דגים ברוטב מרוקאי'],
    "קציצות טבעוניות": ['קציצות טבעוניות']
